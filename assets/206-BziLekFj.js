const l="206",n="几何平均值最大子数组",m="B",g=200,a=`从一个长度为N的正数数组numbers中找出长度至少为L且几何平均值最大子数组，并输出其位置和大小。（K个数的几何平均值为K个数的乘积的K次方根）
...
`,t=`输出子数组的位置（从0开始计数）和大小，中间用一个空格隔开。
...
2
3
4`,output:"2 2",explanation:"长度>=2的子数组中，[3,4]几何平均值最大，起始位置2长度2"},{input:`5 2
0.1
0.2
0.2
0.2
0.1`,output:"2 2",explanation:"多个最大几何平均值子数组，选最短的"}],s=`**解题思路：**
...
**时间复杂度**：O(N*log(MAX))`,r={java:`import java.util.ArrayList;
...
# 算法调用
print(getResult(n, l, numbers))`,javascript:`/* JavaScript Node ACM模式 控制台输入获取 */
...
function check(n, l, numbers, avg, ans) {
  ...
  return flag;
}`,cpp:"",c:""},c={id:"206",title:n,examType:"B",score:200,description:a,inputDesc:e,outputDesc:t,examples:i,solution:s,codes:r};export{r as codes,c as default,a as description,m as examType,i as examples,l as id,e as inputDesc,t as outputDesc,g as score,s as solution,n as title};
