const s="177",n="组装最大可靠性设备",d="",c=200,i=`一个设备由N种类型元器件组成(每种类型元器件只需要一个，类型type编号从0~N-1)，
...
`,t=`符合预算的设备的最大可靠性，如果预算无法买齐N种器件，则返回 -1
...
1 70 200
2 50 100
2 60 200`,output:"60",explanation:"预算500，选择类型0可靠性80价格100、类型1可靠性70价格200、类型2可靠性60价格200，总价500，最小可靠性60"},{input:`100 2
3
0 90 200
1 80 100
1 70 50`,output:"-1",explanation:"预算100无法同时购买类型0和类型1的元器件"}],l=`**解题思路：**
...
**时间复杂度**：O(N*logN*logR)`,r={java:`import java.util.ArrayList;
...
# 算法调用
print(getResult())`,javascript:"",cpp:"",c:""},y={id:"177",title:n,examType:"",score:200,description:i,inputDesc:e,outputDesc:t,examples:a,solution:l,codes:r};export{r as codes,y as default,i as description,d as examType,a as examples,s as id,e as inputDesc,t as outputDesc,c as score,l as solution,n as title};
