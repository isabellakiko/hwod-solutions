const s="131",n="树状结构查询",c="A",a=200,e=`通常使用多行的节点、父节点表示一棵树，比如
西安 陕西 陕西 中国 江西 中国 中国 亚洲 泰国 亚洲
输入一个节点之后，请打印出来树中他的所有下层节点`,t=`第一行输入行数，下面是多行数据，每行以空格区分节点和父节点
接着是查询节点`,r="输出查询节点的所有下层节点。以字典序排序",i=[{input:`5
b a
c a
d c
e c
...
c`,output:`d
e
f`,explanation:"树结构：a为根，b/c为a的子节点，d/e为c的子节点，f为d的子节点。查询c的下层节点有d/e/f"},{input:`5
b a
c a
d c
e c
...
d
e
f`,explanation:"查询根节点a的所有下层节点，按字典序输出"}],d=`**解题思路：**
...
**时间复杂度**：O(NlogN)`,o={java:`import java.util.*;
...
for node in result:  # 打印结果集中的每个节点
    print(node)`,javascript:`const readline = require("readline");
...
int main() {
    ...
    return 0;
}`},u={id:"131",title:n,examType:"A",score:200,description:e,inputDesc:t,outputDesc:r,examples:i,solution:d,codes:o};export{o as codes,u as default,e as description,c as examType,i as examples,s as id,t as inputDesc,r as outputDesc,a as score,d as solution,n as title};
